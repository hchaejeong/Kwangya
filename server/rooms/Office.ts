...
export class Office extends Room<N1Building> {
    ...
    async onCreate(options: IRoomData) {
        ...
        this.onMessage(Message.UPDATE_PLAYER, (client, message: { x: number; y: number; name: string, anim: string }) => {
    ...
    async onAuth(client: Client<this["clients"] extends ClientArray<infer U, any> ? U : never, this["clients"] extends ClientArray<infer _, infer U> ? U : never>, options: any, request?: IncomingMessage | undefined) {
