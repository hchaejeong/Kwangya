...
export const useUserStore = create<UserState>((set) => ({
    ...
    toggleBackgroundMode: () => 
        set((state) => ({ 
            backgroundMode: state.backgroundMode === BackgroundMode.DAY ? BackgroundMode.NIGHT : BackgroundMode.DAY 
        })),
