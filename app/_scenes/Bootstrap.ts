...
export default class Bootstrap extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('backdrop_day', 'public/assets/background/backdrop_day.png')
    this.load.atlas(
      'cloud_night',
      'assets/background/cloud_night.png',
      'assets/background/cloud_night.json'
    )
    this.load.image('backdrop_night', 'public/assets/background/backdrop_night.png')
    ...
    this.load.spritesheet('tiles_wall', 'public/assets/map/FloorAndGround.png', {
      frameWidth: 32,
      frameHeight: 32,
    })
    ...
    this.load.spritesheet('whiteboards', 'public/assets/items/whiteboard.png', {
      frameWidth: 64,
      frameHeight: 64,
    })
    this.load.spritesheet('vendingmachines', 'public/assets/items/vendingmachine.png', {
      frameWidth: 48,
      frameHeight: 72,
    })
    this.load.spritesheet('office', 'public/assets/tileset/Modern_Office_Black_Shadow.png', {
      frameWidth: 32,
      frameHeight: 32,
    })
